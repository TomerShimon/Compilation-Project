...
public class AST_CLASSDEC_EXT extends AST_CLASSDEC
{
	/****************/
	/* DATA MEMBERS */
	/****************/
	...
	/* CONSTRUCTOR(S) */
	/******************/
	public AST_CLASSDEC_EXT(String id1, String id2, AST_CFIELD_LIST cField_lst, int line)
	{
		/******************************/
	...
	public void PrintMe()
	{
		...
		/**************************************/
		System.out.print("AST NODE CLASSDEC_EXT\n");
	...
	{	
		TYPE prev = SYMBOL_TABLE.getInstance().find(id1);
		if(prev != null)
		{
			System.out.format("ERROR name already exists: %s\n",id1);
			throw new SEMANTIC_ERROR_EXCEPTION(String.valueOf(this.line));
		}
		TYPE father = SYMBOL_TABLE.getInstance().find(id2);
		if(father == null)
		{
			System.out.format("ERROR no father class found: %s\n",id2);
			throw new SEMANTIC_ERROR_EXCEPTION(String.valueOf(this.line));
		}
		if(!father.isClass())
		{
			System.out.format("ERROR inherited name is not a class: %s\n",id2);
			throw new SEMANTIC_ERROR_EXCEPTION(String.valueOf(this.line));
		}
		/*************************/
		/* [1] Begin Class Scope */
		...
		/***************************/
		TYPE_CLASS t = new TYPE_CLASS((TYPE_CLASS) father,id1,null);
		...
		/************************************************/
		symbol_table_entry = SYMBOL_TABLE.getInstance().enter(id1,t);
