...
public class SYMBOL_TABLE
{
	...
	public SYMBOL_TABLE_ENTRY enter(String name,TYPE t) // changed it to return SYMBOL_TABLE_ENTRY instead of void
	{
		/*************************************************/
		...
		/**************************************************************************/
		SYMBOL_TABLE_ENTRY e = new SYMBOL_TABLE_ENTRY(name,t,hashValue,scope,next,top,top_index++);
	...
	{
		SYMBOL_TABLE_ENTRY tmp_top = top;
		while(tmp_top.name != "SCOPE-BOUNDARY")
		{
			if(name.equals(tmp_top.name))
				return tmp_top.type;
			tmp_top = tmp_top.prevtop;
		}
		return null;
	}

	public TYPE find_in_func(String name)
	{
		SYMBOL_TABLE_ENTRY tmp_top = top;
		while(tmp_top.type.name != "$func")
		{
			if(name.equals(tmp_top.name))
				return tmp_top.type;
			tmp_top = tmp_top.prevtop;
	...
	public void beginScope_func()
	{
		...
		enter(
			"SCOPE-BOUNDARY",
			new TYPE_FOR_SCOPE_BOUNDARIES("$func"));
